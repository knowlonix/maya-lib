...
kPluginNodeTypeName = "spyTwistNodeFloor"

yTwistNodeFloorId = OpenMaya.MTypeId(0x8702)

# Node definition
class yTwistNodeFloor(OpenMayaMPx.MPxDeformerNode):
	# class variables
...
def initializePlugin(mobject):
	...
	try:
		mplugin.registerNode( kPluginNodeTypeName, yTwistNodeFloorId, nodeCreator, nodeInitializer, OpenMayaMPx.MPxNode.kDeformerNode )
	except:
